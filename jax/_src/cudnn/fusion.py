...
def call_cudnn_fusion(f, *args, **kwargs):
    """Creates a new cudnn_fusion corresponding to calling the given function f with args and kwargs."""
...
def _cudnn_fusion_stablehlo_lowering(
    ...
    *args,
    ...
    """
    impl = mlir.core_call_lowering(ctx, *args, name=name + ".impl", call_jaxpr=jaxpr)
...
mlir.register_lowering(cudnn_fusion_p, _cudnn_fusion_stablehlo_lowering)
